<template>
  <section id="closing" class="bg-bg py-24 pb-20 relative overflow-hidden text-center">
    ...
    <div class="closing-doodle cd1">♥</div>
    <div class="closing-doodle cd2">★</div>
    <div class="closing-doodle cd3">♪</div>
    <div class="closing-doodle cd4">✦</div>

    <div class="relative z-2 max-w-[700px] mx-auto px-6">
      <div class="reveal">
        <div class="font-bang text-[clamp(3rem,11vw,7rem)] tracking-[.04em] leading-[.9] text-cream2 [text-shadow:4px_4px_0_rgba(0,0,0,.8)] mb-[.1em]">TERIMA KASIH</div>
        <div class="font-bang text-[clamp(1.6rem,5.5vw,3.5rem)] tracking-[.05em] text-orange [text-shadow:-2px_-2px_0_#000,2px_2px_0_#000,0_0_30px_rgba(224,124,0,.4)] [-webkit-text-stroke:1px_#000] [paint-order:stroke_fill] mb-6">UNTUK 10 TAHUN CERITA</div>
        <p class="font-type text-[.9rem] text-cream opacity-75 max-w-[520px] mx-auto mb-5 leading-[1.85]">
          Untuk setiap orang yang pernah hadir, berkontribusi, tertawa, menangis, berjuang, dan pulang sebagai keluarga.
        </p>
