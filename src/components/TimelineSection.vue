          ...
          <div class="flex gap-6 w-max px-8 pt-2.5 pb-2.5 relative z-2">
            ...
            >
              ...
              <div class="tl-polaroid bg-cream2 p-[6px_6px_24px] shadow-[2px_4px_12px_rgba(0,0,0,.7),0_0_0_1px_rgba(0,0,0,.4)] -rotate-2 transition-[transform,box-shadow] duration-300">
                <img
                  :class="y.photo ? 'w-[190px] h-[170px] object-cover sepia-[.45] contrast-[1.1]' : 'w-[90px] h-[70px] object-contain bg-[#211a0e] p-2.5'"
                  loading="lazy"
                ...
                >
                <div v-if="y.photo" class="absolute bottom-[21px] right-px z-6 w-[50px] h-[50px] rounded-full bg-white shadow-[0_1px_5px_rgba(0,0,0,.6)] overflow-hidden">
                  <img
