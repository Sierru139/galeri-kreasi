      ...
      <div class="relative max-w-full max-h-[80vh] flex items-center justify-center" @click.stop>
        <div class="relative max-w-full max-h-[80vh] inline-block">
          ...
          <img 
            ...
            @error="e => e.target.src = `https://drive.google.com/thumbnail?id=${selectedTimeline.photo || selectedTimeline.logo}&sz=w1200`"
          />
          ...
          >
            <img 
              ...
              @error="e => e.target.src = `https://drive.google.com/thumbnail?id=${selectedTimeline.logo}&sz=w160`"
            />
          </div>
        </div>
      </div>
