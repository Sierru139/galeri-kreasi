...
const philosophies = {
  2015: "filosofi logo kreasi bentuk perahu itu suatu perjalanan pertama kali inagurasi kreatifitas jurusan sistem informasi pertama kali berlayar dengan namanya dan sebagai simbolis jadi navigasi menuju tujuan barunya kita di jurusan sistem informasi",
  2016: "Semut , yang saling bergotong royong untuk tujuan bersama",
